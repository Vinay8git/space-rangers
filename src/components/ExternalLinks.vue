      ...
      <div class="my-4 width-limit mx-auto">
        ...
        <div class="text-center">
          ...
          <p class="text-secondary font-italic">
            Space Rangers is an independent hobby project by a guy learning
            Vue. No endorsements or partnerships exist between Space
            Rangers and the included organizations.
          </p>
        </div>
      </div>
    </div>
