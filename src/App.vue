<template>
  <div id="app" v-cloak>
    <div id="marqueecontainer">
      <p id="marquee"> LOVE SPACE RANGERS? SUPPORT THE PROJECT AND <a class="marquee-btn" href="https://github.com/vINAY8GIT/space-rangers/" target="_blank" rel="noopener"><i class="fas fa-star"></i>&nbsp; STAR ON GITHUB <span id="star">&nbsp;7&nbsp;</span></a></p>
    </div>
          ...
          <ul class="navbar-nav mr-auto text-center">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu bg-primary" aria-labelledby="externalDropdown">
                ...
                <li class="nav-item">
                  <a href="https://github.com/Vinay8git/space-rangers" target="_blank" rel="noopener" class="nav-link ml-1"><i class="fas fa-code"></i> GITHUB</a>
                </li>
                <li class="nav-item">
                  <a href="https://www.linkedin.com/in/vinay-yadav-0a7275214/" target="_blank" rel="noopener" class="nav-link ml-1"><i class="fas fa-coffee"></i> SUPPORT</a>
                </li>
                <li class="nav-item">
                  <a href="https://twitter.com/" target="_blank" rel="noopener" class="nav-link ml-1"><i class="fab fa-twitter"></i> TWITTER</a>
                </li>
                <li class="nav-item">
    ...
    <div class="bg-primary py-5">
      <div id="footer" class="container my-4">
        <router-link to="/" class="footer-child fc-1">SPACE RANGERS</router-link>
        <div class="footer-child fc-2">
            <a href="https://www.linkedin.com/in/vinay-yadav-0a7275214/" target="_blank" rel="noopener" class="text-light">{{trademark}} &copy; {{copy}}</a><br>
            <a href="https://twitter.com/" target="_blank" rel="noopener" class="mx-2 text-light" aria-label="Rocket Downrange - Twitter link"><i class="fab fa-twitter fa-2x"></i></a>
            <a href="https://www.linkedin.com/in/vinay-yadav-0a7275214/" target="_blank" rel="noopener" class="mx-2 text-light" aria-label="Rocket Downrange - Link to support the project on Buy Me a Coffee"><i class="fas fa-coffee fa-2x"></i></a>
        </div>
...
export default {
  data() {
    return {
      ...
      trademark: "Made on Earth by Galactus & Star",
    };
  },
  mounted() {
