...
export default {
  ...
  metaInfo: {
    ...
    meta: [
      ...
      { property: "og:title", content: "Space Rangers" },
      { property: "og:site_name", content: "Space Rangers" },
      ...
      { name: "twitter:creator", content: "Github: @Vinay8git" },
      {
      ...
      { itemprop: "name", content: "Rocket Downrange" },
      {
